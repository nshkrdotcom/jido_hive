defmodule JidoHiveWorkerRuntime.EscriptBootstrap do
  @moduledoc false
  ...
  @config_dir Path.join(System.user_home!(), ".config/hive")
  ...
  defp configure_tzdata do
    data_dir = Path.join(@config_dir, "tzdata")
  ...
  defp configure_erlexec do
    priv_dir = Path.join(@config_dir, @erlexec_config_prefix)
