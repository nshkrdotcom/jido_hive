...
`examples/jido_hive_termui_console` is the interactive operator console for
`jido_hive`.
...
- `lib/jido_hive_termui_console/app.ex`: top-level app update loop and async effect dispatch
