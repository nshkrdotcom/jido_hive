defmodule JidoHivePublications.PublicationWorkspace do
  @moduledoc false
  ...
  def build(_plan, _auth_state, _opts), do: build(%{}, %{})
  ...
  defp normalize_binding(binding) do
    %{
      channel: Map.get(binding, "channel") || Map.get(binding, :channel),
