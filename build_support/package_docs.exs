defmodule JidoHive.Build.PackageDocs do
  ...
  defp extras(package_title, root_prefix) do
    [
      ...
      {Path.join(root_prefix, "README.md"), filename: "workspace_readme", title: "Workspace Overview"},
      {Path.join(root_prefix, "docs/architecture.md"), filename: "architecture", title: "Architecture"},
      {Path.join(root_prefix, "docs/debugging_guide.md"),
       filename: "debugging_guide", title: "Debugging Guide"},
      {Path.join(root_prefix, "setup/README.md"), filename: "setup_toolkit", title: "Setup Toolkit"},
      {Path.join(root_prefix, "docs/developer/multi_agent_round_robin.md"),
       filename: "multi_agent_round_robin",
  ...
  defp groups_for_extras(root_prefix) do
    [
      "Package": ["README.md"],
      "Project Overview": [Path.join(root_prefix, "README.md"), Path.join(root_prefix, "LICENSE")],
      "User Guides": [
